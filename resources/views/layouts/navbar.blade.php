            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ $title === 'Now Playing' ? 'active' : '' }}"
                                href="/now-playing">Now Playing</a></li>
                        <li><a class="dropdown-item {{ $title === 'Popular' ? 'active' : '' }}"
                                href="/popular">Popular</a></li>
                        <li><a class="dropdown-item {{ $title === 'Top Rated' ? 'active' : '' }}"
                                href="/top-rated">Top Rated</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item {{ $title === 'Upcoming' ? 'active' : '' }}"
